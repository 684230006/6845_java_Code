...
public class W07_04_aboutCircle {
    public static void main(String[] args) {
        //ต้องการให้ผู็ใช้เลือกว่าจะคำนวณอะไรเกี่ยวกับวงกลม : เส้นรอบวง หรือ พื้นที่
        // สิ่งที่ต้องรับเข้ามาเกี่ยวกับวงกลม คือ รัศมี (radius)
        //เส้นรอบวง = 2* pi * r
        //พื้นที่ + pi * r^2
...
System.out.println("กรุณใส่ รัศมี");
